...
class OjWarehouseRefreshDispatcherTest {
    ...
    @Test
    void refreshesCurrentWarehouseStateWhenACollectedHandleWasRemovedAfterFinalize() {
        ...
        OjWarehouseRefreshDispatcher dispatcher = new OjWarehouseRefreshDispatcher(
                List.of(handler),
                droppingGuard()
        );

        OjSubmissionCollectionJobRefreshResult result = dispatcher.refresh(collectionResultWithHandle(
                "CODEFORCES",
                "batch-1",
                "old-handle"
        ));
    ...
    private static OjSubmissionCollectionResult collectionResultWithHandle(
            String ojName,
            String batchId,
            String handle
    ) {
        ...
        return new OjSubmissionCollectionResult(
                ...
                1,
                batchId,
                "ods_codeforces_submission",
                1,
                now,
                null,
                List.of(OjSubmissionCollectionHandleResult.success(handle, 1, 1))
        );
    }
